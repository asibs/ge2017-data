...
su vagrant << EOF
    ...
    echo "*** STEP 0 - Set locale ***"
    # Necessary to ensure the postgresql install uses UTF-8 as expected by rails
    sudo /usr/sbin/update-locale LANG=en_GB.UTF-8 LC_ALL=en_GB.UTF-8
